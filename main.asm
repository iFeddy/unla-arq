...
;DECLARACION DE ESPACIOS DE MEMORIA A USAR		
		...
		D3
		D4
		INPUT_1								;PRIMER INPUT (0x000 A 0xFFF)
		INPUT_2								;SEGUNDO INPUT (0x000 A 0xFFF)
		AUX_W
		AUX_STATUS
		CONT_AR	
		CONT_AR_2
...
SUMAR	MACRO	DIGITO
		...
		CLRF	DIGITO				; LO PONE EN 0 PORQUE Z = 1
		ENDM						
...
BOTONES
		...
		CALL	DEMORA_AR
		BTFSC	BTN_G2
		SUMAR	D3				;MUESTRA EL DISPLAY4?
		BTFSC	BTN_R
		CALL	DEMORA_AR
		BTFSC	BTN_R
		SUMAR	D2				;MUESTRA EL DISPLAY2
		BTFSC	BTN_M
		CALL	DEMORA_AR
		BTFSC	BTN_M
		SUMAR	D1				;MUESTRA EL DISPLAY1
		GOTO 	BOTONES
